...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="View2" runat="server">
            ...
            <asp:Label ID="PositionHeader" runat="server" Width="700px" Font-Size="X-Large" Font-Bold="true"></asp:Label>
            <br />
            <asp:Panel ID="Panel4" runat="server" Style="margin-left: 0px; float: right">
                ...
                <br />
                <asp:Panel ID="Panel1" runat="server" Style="margin-left: 0px; align-content:center;" Width="600px">
