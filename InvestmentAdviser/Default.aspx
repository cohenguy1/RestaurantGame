...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align: center; width: 800px; margin: 0 auto;">
        <table style="text-align: center; max-width: 800px; font-size: large">
            ...
            <tr>
                <td>In this game you and your Human Resource (HR) executive are in charge of hiring 10 ScenarioTurns for the restaurant. The HR executive will be doing the interviewing and hiring and you will choose the uniform for each position.</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
